...
b1_velxyz_binCM     = np.array([0, 0.5*(m2/m_bin)*v_redmass,0])
b2_velxyz_binCM     = np.array([0,-0.5*(m1/m_bin)*v_redmass,0])
#-----------------------------------------------------------------
#IC for b3:
#-----------------------------------------------------------------
b3_posxyz_binCM     = np.array([2.5*SMA_bin,0,0])
...
time_arr_test   = np.zeros(Nsteps, dtype='d') 
